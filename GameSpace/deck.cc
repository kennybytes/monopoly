...
void Deck :: chance(Player p)
{
   ...
   {	
	...
	<< "If owned, throw dice and pay owner 10x amount thrown." << endl;
	...
	case 3:
	case 4:
cout << " Advance token to the nearest Railroad and pay owner 2x rental to which he is otherwise entitled. If unowned, may buy." << endl;
